...
<div class="container">
    <div class="row">
        ...
        <div class="col col-lg-3">
            <a href="{{route('admin.category.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> Create category List</a>
        </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                    ...
                    <form method="post" action="{{ route('admin.category.destroy', $row->id)}}"  onsubmit="return confirm('Are you sure')">
